    ...
    <main className="min-h-screen flex flex-col items-center justify-center gap-8 px-6">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 text-center max-w-md">
        ...
        <div>
          ...
          <p className="mt-1 text-white/50 text-sm">@{user.username} · Tier {user.tier}</p>
        </div>

        <div
          className="flex items-center gap-3 rounded-2xl border border-[#59e184]/20 px-6 py-4"
          style={{ background: "rgba(89,225,132,0.06)" }}
        >
          <Zap size={20} style={{ color: "#59e184" }} />
        ...
        <button
          ...
          className="flex items-center gap-2 text-sm text-white/40 hover:text-red-400 transition-colors mt-2"
        >
          <LogOut size={16} />
          Log out
        </button>
